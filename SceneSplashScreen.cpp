...
void SceneSplashScreen::OnCreate() {
    int textureID = textureAllocator.Add(workingDir.Get()+"2denginelogo1.png");
    Debug::Log("Loading Splashscreenlogo..");
    if (textureID >=0)
    {
        ...
        Debug::Log("Splashscreenlogo loaded..");
    } else
    {
        Debug::LogError("COULDNT LOAD LOGO");
    }
...
void SceneSplashScreen::Draw(Window &window) {
    sf::RenderWindow *hndle = window.getWindowHandle();
    hndle->clear(sf::Color(200,0,0));
